...
CREATE TABLE IF NOT EXISTS users (
    ...
    media_ids BIGINT[]  -- Array de IDs de mídias associadas a esta utilizador
    );
...
CREATE TABLE IF NOT EXISTS media (
    ...
    user_ids BIGINT[]  -- Array de IDs de utilizador associados a esta mídia

    );

-- Tabela de junção para relacionar utilizador e mídias
